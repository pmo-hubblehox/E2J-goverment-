...
import com.hubblehox.e2j.security.JwtAuthFilter;
    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        return http
                ...
                .authorizeHttpRequests(auth -> auth
                        ...
                        .requestMatchers("/head-counsellor/**").hasRole("HEAD_COUNSELLOR")
                        .requestMatchers("/industry-partner/**").hasRole("INDUSTRY_PARTNER")
